// Generated by Wrangler by running `wrangler types` (hash: d56e1f26cb4a55bbb138a296f350e3e5)
// Runtime types generated with workerd@1.20250409.0 2025-05-06 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TO_EMAIL: "scott@mazaryk.com";
		BCC_EMAIL: "webmaster@mazaryk.com";
		RESEND_API_KEY: string;
		CLIENT_RESEND_API_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TO_EMAIL" | "BCC_EMAIL" | "RESEND_API_KEY" | "CLIENT_RESEND_API_KEY">> {}
}
